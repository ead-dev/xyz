...
?>
     ...
     <div class="mainnav__categoriy py-3">
        ...
        <ul class="mainnav__menu nav flex-column">
           <li class="nav-item">
               <a href="/home" class="nav-link mininav-toggle active"><i class="demo-pli-home fs-5 me-2"></i>
                   <span class="nav-label mininav-content ms-1">Accueil</span>
               </a>
           </li>

           <li class="nav-item">
               <a href="/clients" class="nav-link mininav-toggle"><i class="pli-conference fs-5 me-2"></i>
